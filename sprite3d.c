...
/* Display row 0 lands on this player byte: the display list opens with 24 blank
 * scanlines (12 two-line bytes) and ANTIC starts around byte 16. */
#define PMG_TOP_OFFSET 28
